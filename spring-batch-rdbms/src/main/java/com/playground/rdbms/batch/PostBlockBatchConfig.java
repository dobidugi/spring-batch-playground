...
// ./gradlew bootRun --args='--spring.batch.job.name=postBlockBatchJob startDateTime=2025-11-03T00:00:00 endDateTime=2025-11-10T23:59:59 jobId=1'
...
public class PostBlockBatchConfig {
    ...
    public JpaCursorItemReader<Post> postBlockReader(
        ...
        System.out.println("🔥 startDate=" + startDateTime + ", endDate=" + endDateTime + ", entityManagerFactory=" + entityManagerFactory);
...
//                calculateTimeValidity(report.getre());        // 시간 가중치 계산
            }
